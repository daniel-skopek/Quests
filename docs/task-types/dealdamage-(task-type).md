...
| `projectile-item`             | Specific item which should be used to summon the projectile (for example an arrow). | ItemStack                            | No       | \-      | Accepts standard [item definition](../configuration/defining-items).                                                                                                                               |
| `data`                        | The data code for the item.                                                         | Integer                              | No       | 0       | This field is not used in Minecraft versions 1.13+, nor is it compatible with ItemStack definitions.                                                                                               |
| `exact-match`                 | Whether the item should exactly match what is defined.                              | Boolean                              | No       | true    | \-                                                                                                                                                                                                 |
| `projectile-item-exact-match` | Whether the projectile item should exactly match what is defined.                   | Boolean                              | No       | true    | \-                                                                                                                                                                                                 |
